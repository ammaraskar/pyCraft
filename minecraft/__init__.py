...
KNOWN_MINECRAFT_VERSION_RECORDS = [
    ...
    Version('20w49a',                PRE | 8,  True),
    Version('20w51a',                PRE | 9,  True),
    Version('1.16.5-rc1',            PRE | 10, True),
    Version('1.16.5',                754,      True),
    Version('21w03a',                PRE | 11, True),
    Version('21w05a',                PRE | 12, True),
    Version('21w05b',                PRE | 13, True),
    Version('21w06a',                PRE | 14, True),
    Version("21w07a",                PRE | 15, True),
    Version("21w08a",                PRE | 16, True),
    Version("21w08b",                PRE | 17, True),
    Version("21w10a",                PRE | 18, True),
    Version("21w11a",                PRE | 19, True),
    Version("21w13a",                PRE | 20, True),
    Version("21w14a",                PRE | 21, True),
    Version("21w15a",                PRE | 22, True),
    Version("21w16a",                PRE | 23, True),
    Version("21w17a",                PRE | 25, True),
    Version("21w18a",                PRE | 26, True),
    Version("21w19a",                PRE | 27, True),
    Version("21w20a",                PRE | 28, True),
    Version("1.17-pre1",             PRE | 29, True),
    Version("1.17-pre2",             PRE | 30, True),
    Version("1.17-pre3",             PRE | 31, True),
    Version("1.17-pre4",             PRE | 32, True),
    Version("1.17-pre5",             PRE | 33, True),
    Version("1.17-rc1",              PRE | 34, True),
    Version("1.17-rc2",              PRE | 35, True),
    Version("1.17",                  755,      True),
    Version("1.17.1-pre1",           PRE | 36, True),
    Version("1.17.1-pre2",           PRE | 37, True),
]
